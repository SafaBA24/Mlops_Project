...
sklearn_classifier = RandomForestClassifier(n_estimators=n_estimators, random_state=42)
...
mlflow.log_param("n_estimators", n_estimators)  # Enregistrement du paramètre n_estimators
...
# Enregistrer le TfidfVectorizer
mlflow.sklearn.log_model(tfidf_vectorizer, "TFIDF_Vectorizer")

# Enregistrer le modèle avec sa signature
mlflow.sklearn.log_model(sklearn_classifier, "RF_model", signature=signature)